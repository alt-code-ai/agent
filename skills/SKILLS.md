## Prompts used to create skills

### fiction-writing-poetry-advanced

> Create a new skill, fiction-writing-poetry-advanced that provides expert guidance on writing literature 
> grade poetry, refer to and synthesise guidance from Writing Poems by Wallace and Boisseau, 
> On Poetry by Glyn Maxwell and other well reviewed / regarded poets and reference material. 
> Use the skill-creator skill, and use the exa mcp to search for extra context.  
> Build additional skill context as required for stronger guidance.  Evaluate the skill and install 
> ready for use (adjacent with existing fiction-writing-poetry skill and ready for performance comparison).

### fiction-writing-prose-advanced
...
>Create a new skill, fiction-writing-story-development-advanced that provides expert guidance on 
> story (narrative) development.  Synthesise techniques from well regarded sources such as McKee, 
> Egri, Truby, Schechter, Snyder, Vogler/Campbell, and Charters. Use the skill-creator skill, and 
> use the exa mcp to search for extra context.  Build additional skill context as required for stronger 
> guidance.  Evaluate the skill and install ready for use 
> (adjacent with existing fiction-writing-story-development skill and ready for performance comparison)

### presuavive-reading-and-writing

> Create a new skill presuavive-reading-and-writing that provides expert guidance on reading and writing of persuasive texts,
focusing on practical elements of formal argument (for example, premisis, forms of reasoning, cogency, fallacies) 
and also elements of style.  Synthesise techniques from well A Practcal Study of Argument by Trudy Govier, 
The Elements of Style by Strunk and White and other well regarded sources in both argment and style.  Use the skill-creator skill, and
use the exa mcp to search for extra context.  Build additional skill context as required for stronger
guidance.  For reading and critique, the skill should provide deep guidance to identify strengths and weakness of the text, identifying fallacies and
other failures of cogency, and offer counter-arguments. For writing the skill should provide deep guidance on improving the cogency of the text, identifying and
eliminating fallacies, logical inconsistencies and other well understood and documemented errors.  The skill shold include a gloassary or library of well known 
fallacies, indexed by their techincal and common (lay) names.

### technical-writing

> Create a new skill technical-writing that provides expert guidance and automation for the writing and publishing technical documentation.
Synthesise techniques from well regarded sources on the topic.  Use the skill-creator skill, and
use the exa mcp to search for extra context.  Build additional skill context as required for stronger
